    ...
    <div>
      <div className="bg-black min-h-screen text-[#E7E9EA] max-w-[1400px] mx-auto flex">
        ...
        <div className="sm:ml-16 xl:ml-80 max-w-2xl flex-grow border-gray-700 border-x">
          <div className="flex px-3 py-2 text-lg sm:text-xl font-bold border-b border-gray-700 sticky top-0 z-50">
            <Link href={"/"}>
          ...
          <div className="border-b border-gray-700">
            <div className="flex space-x-3 p-3  border-gray-700">
              ...
              <div>
                ...
                {tweetData.image && (
                  <img
                    className="object-cover border border-gray-700 rouned-md mt-3 max-h-80"
                    src={tweetData.image}
                  />
                )}
              </div>
